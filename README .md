...
As I had a usecase for placeholder images that could be used directly in websites I started writing a backend-API which is the first and so far only service I provide. Initially supposed to be written in Python/Django, during development I switched to Java/Spring Boot just to end up (for now at least) with a Node.js app.
